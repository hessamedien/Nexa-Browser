# nexa_browser_complete_enhanced_fixed.py
import sys
import os
import json
import sqlite3
    ...
    def __init__(self):
        ...
        self.translations = {
            "en": {
                ...
                "page_saved": "Page Saved Successfully",  # اضافه شده
                "print": "Print...",
                "cut": "Cut",
                "copy": "Copy",
                "paste": "Paste",
            ...
            "fa": {
                ...
                "page_saved": "صفحه با موفقیت ذخیره شد",  # اضافه شده
                "print": "چاپ...",
                "cut": "برش",
                "copy": "کپی",
                "paste": "چسباندن",
...
class HamburgerMenu(QMenu):
    ...
    def setup_menu(self):
        ...
        # Edit section
        edit_menu = self.addMenu("✏️ " + trans.tr("edit"))  # اصلاح شده
