...
class HamburgerMenu(QMenu):
    ...
    def setup_menu(self):
        ...
        file_menu.addAction("New Tab", lambda: self.parent().add_new_tab(), "Ctrl+T")
        file_menu.addAction("New Window", lambda: print("New Window"), "Ctrl+N")
        file_menu.addAction("Private Browsing", lambda: print("Private Browsing"), "Ctrl+Shift+P")
        file_menu.addSeparator()
        file_menu.addAction("Save Page As...", lambda: print("Save Page"), "Ctrl+S")
        file_menu.addAction("Print...", lambda: print("Print"), "Ctrl+P")
        ...
        view_menu.addAction("Actual Size", lambda: print("Actual Size"), "Ctrl+0")
        view_menu.addSeparator()
        
        # Toolbars submenu
        toolbars_menu = view_menu.addMenu("Toolbars")
        self.nav_action = toolbars_menu.addAction("Navigation Bar")
        ...
        self.bookmarks_action = toolbars_menu.addAction("Bookmarks Bar")
        self.bookmarks_action.setCheckable(True)
        self.bookmarks_action.setChecked(False)
        
        # Settings section
        settings_menu = self.addMenu("⚙️ Settings")
        settings_menu.addAction("Browser Settings", lambda: self.parent().show_settings_dialog())
        settings_menu.addAction("Homepage Customization", lambda: self.parent().show_homepage_customization())
        settings_menu.addAction("Appearance Settings", lambda: self.parent().show_appearance_settings())
        
        # Help section
        help_menu = self.addMenu("❓ Help")
        help_menu.addAction("About Nexa Browser", lambda: self.show_about())
        help_menu.addAction("Help & Support", lambda: print("Help"))
