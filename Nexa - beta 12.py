...
class NexaBrowser(FluentWindow):
    ...
    def create_toolbar(self):
        ...
        # New tab button - FIXED: Now tabs exists when this is called
    ...
    def update_navigation_buttons(self):
        ...
        if current_browser:
            # You can add logic to enable/disable buttons based on history
            pass
    ...
    def search_web(self):
        search_term = self.url_bar.text().strip()
        if not search_term:
            return
